...
----------------------------------
Base HTTP client for pktIPAM acting as a suite-token CLIENT of a sibling
pkt* app (pktsnmp, for device/ARP data). This is the mirror image of
app/api/suite.py (which is the INBOUND side — pktHub calling into pktIPAM).
...
log = logging.getLogger("pktipam.integrations")


class SuiteClient:
    def __init__(self, base_url: str, suite_token: str, suite_user: str = "pktipam", suite_role: str = "admin"):
