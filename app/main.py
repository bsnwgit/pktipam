...
async def _direct_access_lock(request: Request, call_next):
    ...
    try:
        ...
        async with aiosqlite.connect(cfg.db_path) as db:
            ...
            if presented and stored and _sec.compare_digest(presented, stored):
                ...
                if row and _decode_setting(row[0]) is True:
                    ...
                    if expired:
                        logging.getLogger("pktipam.main").warning(
        ...
        logging.getLogger("pktipam.main").exception("direct-access lock check failed")
...
async def health(request: Request):
    ...
    try:
        ...
        logging.getLogger("pktipam.main").exception("health lock state read failed")
