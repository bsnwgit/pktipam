...
There is no internal-IP counterpart here (unlike pktflow/pktlog/pktsnmp/
pktwifi, which ask pktIPAM over Suite Integration) — pktIPAM already *is*
the source of truth for internal addresses via /api/ip-addresses.
"""
